...
![](dendron-template/assets//assets/images/2020-11-22-13-56-09.png)
...
- They also control the fields that appear in the expanded lookup card you see when you hover over a link in record details, and in the details section when you expand an activity in the activity timeline.
  ![](dendron-template/assets//assets/images/2020-10-21-11-32-35.png)
  Is available from:
...
![](dendron-template/assets//assets/images/2020-10-21-15-30-26.png)
...
![](dendron-template/assets//assets/images/2020-11-23-09-19-37.png)
...
![](dendron-template/assets//assets/images/2020-11-23-09-25-42.png)
...
![](dendron-template/assets//assets/images/2020-11-23-10-27-28.png)
...
![](dendron-template/assets//assets/images/2020-11-23-10-26-06.png)
...
![](dendron-template/assets//assets/images/2020-11-23-09-13-09.png)
![](dendron-template/assets//assets/images/2020-11-23-09-14-35.png)
...
![](dendron-template/assets//assets/images/2020-11-23-11-34-38.png)
...
![\#security-map](dendron-template/assets//assets/images/2020-10-23-09-42-41.png)
...
![\#difference-view-profile](dendron-template/assets//assets/images/2020-10-23-09-27-15.png)
...
![](dendron-template/assets//assets/images/2020-11-22-16-21-05.png)
...
![](dendron-template/assets//assets/images/2020-11-25-10-02-31.png)
...
![\#identity-management-system-map](dendron-template/assets//assets/images/2020-10-23-10-07-18.png)
...
![](dendron-template/assets//assets/images/2020-10-26-09-34-45.png)
...
- IF ( Number_of_deals**c>0, (Number_of_won_deals**c / Number_of_deals\_\_c), 0)
...
- Autonumber the record name, starting with 0: and format: ROBOT SETUP-{0000}
  ...
  - Date, Date\_\_c -> Date type
  - Notes, Notes\_\_c -> Text (long) type
  - Day of the Week, Day_of_the_Week\_\_c -> formula field-> text
...
4. Automate Opportunities:
   ...
   1. add a validation rules:
      / AND (ISCHANGED (Approved\_\_c ), OR($Profile.Name &lt;> 'System Administrator',$Profile.Name &lt;> 'Custom: Sales Profile')) /
      ```
      - only Admin and Custom Sale Profile (Sale Manager) can check
      ```
   2. new validation rules: if opp > 100.000:
      AND(ISCLOSED = TRUE, Amount > 100.000 , Approved\_\_c &lt;> TRUE)
...
- Create task for account owner
  ...
  - Priority: High
- ![](dendron-template/assets//assets/images/2020-10-28-09-23-29.png)
...
![](dendron-template/assets//assets/images/2020-11-25-18-03-22.png)
...
![](dendron-template/assets//assets/images/2020-11-25-18-00-55.png)
...
![](dendron-template/assets//assets/images/2020-11-04-09-26-44.png)
...
- Remove All Columns
  ![](dendron-template/assets//assets/images/2020-11-04-09-29-23.png)
  </details>
...
![](dendron-template/assets//assets/images/2020-11-04-09-36-43.png)
...
![](dendron-template/assets//assets/images/2020-11-04-09-51-43.png)
...
![](dendron-template/assets//assets/images/2020-11-09-14-25-38.png)
...
![](dendron-template/assets//assets/images/2020-11-27-09-36-48.png)
...
![](dendron-template/assets//assets/images/2020-11-27-09-45-04.png)
